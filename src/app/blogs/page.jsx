...
const BlogPage = () => {
    return (
        <div className="min-h-screen bg-gray-100 py-8">
            <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">Blogs Page</h1>
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {blogs.map((blog) => (
                        <div key={blog.id} className="flex flex-col bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <p className="text-gray-800 mb-10 h-auto">{blog.content}</p>
                            <Link href={`blogs/${blog.id}`} type="button" className="bg-blue-500 hover:bg-blue-800 text-white font-bold p-2 text-center">View Details</Link>
                        </div>
                    ))}
                </div>
            </div>
